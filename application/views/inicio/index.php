<?php echo $header; ?>   
<?php //print_r($this->session->usuario); ?>
<div class="row">
<?php print_r($this->session->flashdata("welcome")); ?>
                <div class="col-lg-12">
...
toastr.options = {
  ...
  "positionClass": "<?php echo $this->session->flashdata("welcome")["positionClass"]; ?>",
  "onclick": null,
  "showDuration": "400",
  "hideDuration": "1000",
  "timeOut": "7000",
...
Command: toastr["<?php echo $this->session->flashdata("welcome")["type"]; ?>"]("<?php echo $this->session->flashdata("welcome")["message"];?>", "<?php echo $this->session->flashdata("welcome")["tittle"]?>")
</script>
<?php }?>
